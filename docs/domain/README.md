...
| 물타기 시험 (문서 없음 — ADR 0006) | **시험 (켜져 있으면 모델보다 우선)** | `core/martingale`, `features/scalper/martingaleMode.ts` | 1분봉 정배열·5선 돌파 진입, 익절 사다리 +3/+2/+1, 5선 변곡 배수 물타기, 상한 없음, 15:55 청산. `MARTINGALE_MODE=false`로 모델 복귀 |
