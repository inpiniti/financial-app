> 원문: 주문체결내역.txt (KIS API 포탈 복사본) — 변환 시 필드 추가/삭제 없음
...
| ctx_area_fk200 | 연속조회검색조건200 | String | Y | 200 | (원문에 없음) |
| ctx_area_nk200 | 연속조회키200 | String | Y | 200 | (원문에 없음) |
| output | 응답상세 | Array | Y | - | (원문에 없음) |
...
| sll_buy_dvsn_cd_name | 매도매수구분코드명 | String | Y | 60 | (원문에 없음) |
| rvse_cncl_dvsn | 정정취소구분 | String | Y | 2 | 01 : 정정<br>02 : 취소 |
| rvse_cncl_dvsn_name | 정정취소구분명 | String | Y | 60 | (원문에 없음) |
| pdno | 상품번호 | String | Y | 12 | (원문에 없음) |
| prdt_name | 상품명 | String | Y | 60 | (원문에 없음) |
...
| rjct_rson_name | 거부사유명 | String | Y | 60 | (원문에 없음) |
| ord_tmd | 주문시각 | String | Y | 6 | 주문 접수 시간 |
| tr_mket_name | 거래시장명 | String | Y | 60 | (원문에 없음) |
| tr_natn | 거래국가 | String | Y | 3 | (원문에 없음) |
| tr_natn_name | 거래국가명 | String | Y | 3 | (원문에 없음) |
...
| tr_crcy_cd | 거래통화코드 | String | Y | 60 | (원문에 없음) |
| dmst_ord_dt | 국내주문일자 | String | Y | 8 | (원문에 없음) |
| thco_ord_tmd | 당사주문시각 | String | Y | 6 | (원문에 없음) |
...
| loan_dt | 대출일자 | String | Y | 8 | (원문에 없음) |
