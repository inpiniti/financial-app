> 원문: 정정취소주문.txt (KIS API 포탈 복사본) — 변환 시 필드 추가/삭제 없음
...
|---|---|---|---|
| 미국 | 정정·취소 | TTTT1004U | VTTT1004U |
| 홍콩 | 정정·취소 | TTTS1003U | VTTS1003U |
| 일본 | 정정·취소 | TTTS0309U | VTTS0309U |
| 상해 | 취소 | TTTS0302U | VTTS0302U |
| 심천 | 취소 | TTTS0306U | VTTS0306U |
| 베트남 | 취소 | TTTS0312U | VTTS0312U |
